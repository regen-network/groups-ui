...
export type ProposalsByGroupPolicyAddressQuery = { __typename?: 'Query', allProposals?: { __typename?: 'ProposalsConnection', nodes: Array<(
      { __typename?: 'Proposal' }
      & { ' $fragmentRefs'?: { 'ProposalItemFragment': ProposalItemFragment } }
    ) | null> } | null };

export type ProposalsByProposalIdQueryVariables = Exact<{
  proposalId: Scalars['BigInt']['input'];
}>;


export type ProposalsByProposalIdQuery = { __typename?: 'Query', allProposals?: { __typename?: 'ProposalsConnection', nodes: Array<(
      { __typename?: 'Proposal' }
      & { ' $fragmentRefs'?: { 'ProposalItemFragment': ProposalItemFragment } }
    ) | null> } | null };
